...
public class GameColorsServiceTest {
    ...
    void testCalculateColorsForTeamsOptimizesColorAssignment2() {
        ...
        Assertions.assertNotNull(result);
        Assertions.assertEquals(YahtzeeColor.CRIMSON.getTeamColor().colorId(), result.get("Team A").colorId());
        Assertions.assertNotEquals(YahtzeeColor.CRIMSON.getTeamColor().colorId(), result.get("Team B").colorId());
        Assertions.assertNotEquals(YahtzeeColor.BLACK.getTeamColor().colorId(), result.get("Team B").colorId());
        Assertions.assertEquals(YahtzeeColor.BLACK.getTeamColor().colorId(), result.get("Team C").colorId());
    }
