...
@Configuration
public class JacksonConfiguration { // TODO вынести в модуль
    @Bean
    public ObjectMapper objectMapper() {
        SimpleModule jodaModule = new SimpleModule();

        jodaModule.addSerializer(Instant.class, new JsonSerializer<>() {
            @Override
        ...
        jodaModule.addDeserializer(Instant.class, new JsonDeserializer<>() {
            @Override
